...
** design
1. it will not have mutable state
2. it will be strong-typed languange
3. it will have [[Hindley–Milner type system][https://en.wikipedia.org/wiki/Hindley%E2%80%93Milner_type_system]
